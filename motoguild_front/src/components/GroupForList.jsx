    ...
    <div className="group-container">
      ...
      <div className="group-apply-button-container">
        ...
        <button className="group-apply-button">
          <p onClick={addUserToPendingUsers} className="group-apply-button-text-apply">Aplikuj</p>
        </button>}

        {!isUserTheOwner && props.isPrivate && !isUserInGroup && isUserInPendingUsers &&
        <p className="group-apply-button-text-ask"><br></br>Akceptacja w toku</p>}
        ...
        <button className="group-apply-button">
          <p onClick={deleteUserFromGroup} className="group-apply-button-text-apply">Opuść</p>
        </button>}
